...
class CartAdapter extends TypeAdapter<Cart> {
  ...
  Cart read(BinaryReader reader) {
    ...
    return Cart(
      ...
      products: (fields[3] as List?)?.cast<ProductInCart>(),
    );
  }
...
class ProductInCartAdapter extends TypeAdapter<ProductInCart> {
  @override
  final int typeId = 1;

  @override
  ProductInCart read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ProductInCart(
      ...
      totalPrice: (fields[8] as num?)?.toDouble(),
      cartId: fields[9] == null ? 1 : (fields[9] as num).toInt(),
    );
  }

  @override
  void write(BinaryWriter writer, ProductInCart obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.id)
